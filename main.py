...
def index():
    ...
    <head>
      ...
      <style>
        ...
        #chat { max-width: 800px; margin: auto; background: #1a1a1a; border-radius: 10px; padding: 20px; }
        .message { margin: 10px 0; }
        .user { color: #7fffd4; font-weight: bold; }
        .bot { color: #87cefa; }
        img { max-width: 100%; margin-top: 10px; border-radius: 10px; border: 2px solid #444; }
      </style>
    </head>
    <body>
      <div id="chat">
